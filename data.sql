-- Create the database
CREATE DATABASE shoe_stocks_chatbot;
USE shoe_stocks_chatbot;

-- Create the t_shirts table
CREATE TABLE shoes (
    shoe_id INT AUTO_INCREMENT PRIMARY KEY,
    brand ENUM('Bata', 'Puma', 'Nike', 'CampusX') NOT NULL,
    color ENUM('Red', 'Blue', 'Black', 'White') NOT NULL,
    size ENUM('36', '38', '40', '42', '44') NOT NULL,
...
BEGIN
    ...
    DECLARE brand ENUM('Bata', 'Puma', 'Nike', 'CampusX');
    DECLARE color ENUM('Red', 'Blue', 'Black', 'White');
    DECLARE size ENUM('36', '38', '40', '42', '44');
    DECLARE price INT;
    DECLARE stock INT;
    ...
    WHILE counter < max_records DO
        ...
        SET brand = ELT(FLOOR(1 + RAND() * 4), 'Bata', 'Puma', 'Nike', 'CampusX');
        SET color = ELT(FLOOR(1 + RAND() * 4), 'Red', 'Blue', 'Black', 'White');
        SET size = ELT(FLOOR(1 + RAND() * 5), '36', '38', '40', '42', '44');
...
INSERT INTO shoe_discounts (shoe_id, pct_discount)
VALUES
(1, 10.00),
(2, 15.00),
(3, 20.00),
